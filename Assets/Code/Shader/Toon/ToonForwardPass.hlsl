#ifndef SANDBOX_TOON_FORWARD_PASS_INCLUDED
#define SANDBOX_TOON_FORWARD_PASS_INCLUDED
...
half4 ToonForwardFragment(Varyings input) : SV_Target
{
    ...
    half4 base = SampleToonBase(input.uv);
    ...
    half3 color = ToonFragmentLighting(surface);
